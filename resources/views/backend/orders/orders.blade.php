                ...
                <div class="card-box mb-30">
                    <div class="row">
                        ...
                        <div class="btn-group mb-15 mt-15 ml-5">
                            ...
                            <form action="{{ route('orders') }}" method="GET" class="btn btn-secondary">
                                <button name="status" class="btn text-white" type="submit" value="5" >Packed</button>
                            </form>
                        ...
                        <div class="col-2">
                            <form action="{{ route('orders') }}" name="priceChange" method="GET">
