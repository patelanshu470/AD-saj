                            ...
                            <div class="col-md-8">
                                <div class="tab-content dashboard-content">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" name="editAddress" id="editAddress" action="{{ route('user.updateAddress',encrypt($address->id)) }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <span class="myarrow">
                                                                ...
                                                                placeholder="{{__('Address Type')}}" value='{{ $address->atype }}'>
                                                            </span>
                                                            <datalist id="atypes">
                                                                <option value="home">
                                                                <option value="work">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="" class="form-control square"
                                                            name="landmark" value="{{ $address->landmark }}" id="landmark" type="text">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>City <span class="required">*</span></label>
                                                        <input required="" class="form-control square"
                                                            name="city" value="{{ $address->city }}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Pincode <span class="required">*</span></label>
                                                        <input required="" class="form-control square"
                                                            name="pincode" value="{{ $address->pincode }}" type="number">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>State <span class="required">*</span></label>
                                                        <input required="" class="form-control square"
                                                            name="state" value="{{ $address->state }}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Country <span class="required">*</span></label>
                                                        <input required="" class="form-control square"
                                                            name="country" value="{{ $address->country }}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <div class="checkbox">
                                                            <div class="custome-checkbox">
                                                                <input class="form-check-input" type="checkbox" name="default_address_id" id="default_address_id" value="yes" @if (Auth::user()->default_address_id==$address->id)
                                                                {{"checked='checked"}}
                                                            @endif>
