                                ...
                                <div class="tab-content dashboard-content">
                                    <div class="tab-pane fade active show" id="orders" role="tabpanel"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form method="POST" name="ProductReview" id="ProductReview" action="{{ route('updateReview') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="star-container">
                                                              <input type="radio" name="star" id="five" value="5" {{ $productReview->rating == 5 ? 'checked' : '' }}>
                                                              <label for="five">
                                                                <svg class="star">
                                                                  <use xlink:href="#star"/>
                                                                </svg>
                                                              </label>
                                                              <input type="radio" name="star" id="four" value="4" {{ $productReview->rating == 4 ? 'checked' : '' }}>
                                                              <label for="four">
                                                                <svg class="star">
                                                                  <use xlink:href="#star"/>
                                                                </svg>
                                                              </label>
                                                              <input type="radio" name="star" id="three" value="3" {{ $productReview->rating == 3 ? 'checked' : '' }}>
                                                              <label for="three">
                                                                <svg class="star">
                                                                  <use xlink:href="#star"/>
                                                                </svg>
                                                              </label>
                                                              <input type="radio" name="star" id="two" value="2" {{ $productReview->rating == 2 ? 'checked' : '' }}>
                                                              <label for="two">
                                                                <svg class="star">
                                                                  <use xlink:href="#star" />
                                                                </svg>
                                                              </label>
                                                              <input type="radio" name="star" id="one" value="1" {{ $productReview->rating == 1 ? 'checked' : '' }}>
                                                              <label for="one">
                                                              <svg class="star">
                                                                <use xlink:href="#star" />
                                                              </svg>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div id="img-preview" style="display: block">
                                                                <img src="{{ URL::asset('public/images/review_image/'.$productReview->image)}}" alt="">
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea name="description" id="" cols="20" rows="10" class="">@php
                                                                echo $productReview->description;
                                                            @endphp</textarea>
                                                        </div>
                                                        <input type="text" value="{{ $productReview->id }}" name="review_id" hidden>
                                                        <div class="col-md-12">
