                        ...
                        <div class="col-lg-5">
                            <div class="login_wrap widget-taber-content p-30 background-white border-radius-10 mb-md-5 mb-lg-0 mb-sm-5">
                                <div class="padding_eight_all bg-white">
                                    ...
                                    <form method="POST" action="{{ route('otp.getlogin.mobile') }}" class="otp-form" name="otp-form" id="validation">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <p class="mt-3 text-center" style="display: none;" id="display_block_id">
                                            Didn't recieve an OTP?<a class=""  href="{{route('otp.resend.mobile',$para_no)}}" style="pointer-events: none; margin-left:5px;"  id="resend">Resend OTP</a>
                                        </p>
                                    </form>
                                </div>
                            </div>
