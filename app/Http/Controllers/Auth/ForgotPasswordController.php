...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    public function submitForgetPasswordForm(Request $request)
    {
        ...
        Mail::send('frontend.auth.forgot_password_mail', ['token' => $token,'email' => $request->email,], function($message) use($request){
            $message->to($request->email);
            $message->subject('Reset Your Sajh Dhaj Ke Account Password');
        });
